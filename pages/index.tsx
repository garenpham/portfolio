...
const style = {
	wrapper: `bg-[rgb(36,36,36)] text-white h-[96vh] snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0 md:scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80 scroll-smooth`,
	start: `snap-start`,
	center: `snap-center`,
