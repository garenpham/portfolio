...
const style = {
	wrapper: `md:h-screen relative flex flex-col text-center md:text-left md:flex-row md:max-w-7xl justify-evenly mx-auto items-center`,
	title: `absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl ml-4`,
	content: `flex flex-col space-y-6 md:space-y-10 mt-[10rem] md:mt-[2rem]`,
